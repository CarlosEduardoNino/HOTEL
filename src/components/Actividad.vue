  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4" v-for="(activity, index) in activities" :key="index">
        <div :class="['cardw', `cardw-${index + 1}`]" v-motion-slide-visible>
          <img
            :src="activity.image"
...
.cardw-1 { background-color: #e8f5e9; }
.cardw-2 { background-color: #fff3e0; }
.cardw-3 { background-color: #e1f5fe; }
.cardw-4 { background-color: #fce4ec; }
.cardw-5 { background-color: #f3e5f5; }
.cardw-6 { background-color: #e8eaf6; }
.cardw-7 { background-color: #f1f8e9; }
.cardw-8 { background-color: #fff8e1; }
.cardw-9 { background-color: #e0f2f1; }
...
@media screen and (max-width: 768px) {
  ...
  .cardw-title { font-size: 1.2rem; }

  .cardw-type { font-size: 0.8rem; }
  body{
    background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);
    font-family: 'Poppins', sans-serif;
